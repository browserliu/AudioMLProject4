...
KMeans_HDF5 = '/mnt/alderaan/mlteam3/Assignment4/data/gmm_ubm/'+str(kmeans_hdf5_filename).strip()
GMM_HDF5 = '/mnt/alderaan/mlteam3/Assignment4/data/gmm_ubm/'+str(gmm_hdf5_filename).strip()
