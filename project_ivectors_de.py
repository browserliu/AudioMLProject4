...
ubm_hdf5 = "/mnt/alderaan/mlteam3/Assignment4/data/gmm_ubm_de_39D/gmm_voxde_39D_512G.hdf5"
tv_hdf5 = 'model/tv_512G_DE.hdf5'
...
def project_ivectors(input_features):
    ...
    for root, dir, files in os.walk(input_features):
        ...
        ivectors_path = 'ivectors/ivectors_vox_DEubm_ubm/'+ str(gaussians) + '/' + input_features.split('/')[-1]
