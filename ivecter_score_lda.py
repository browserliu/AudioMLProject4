...
train_ivectors_path = '/mnt/alderaan/mlteam3/Assignment4/ivectors/ivectors_vox_ENubm_balanced15fold/512/vox_for_training_probe_balanced15fold'
test_ivectors_path = '/mnt/alderaan/mlteam3/Assignment4/ivectors/ivectors_vox_ENubm_balanced15fold/512/vox_for_training_model_balanced15fold'
...
for probe in speaker_list:
	...
	for probe_ivector in probe_ivectors:
		...
		for model in speaker_list:
			...
			# lda
			model_ivectors_lda_projected = map(lda_machine.forward, model_ivectors)
			probe_ivector_lda_projected = lda_machine.forward(probe_ivector)
			score = cosine_score(model_ivectors_lda_projected, probe_ivector_lda_projected)
...
df.to_csv("results/ivector_lda_ENubm_balanced15fold.csv")